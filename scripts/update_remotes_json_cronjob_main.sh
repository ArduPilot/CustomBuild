...
# to do a hot reload of remotes.json on custom.ardupilot.org

# CBS_REMOTES_RELOAD_TOKEN can be supplied as an environment
# variable in the crontab line, for example:

# 0 * * * * CBS_REMOTES_RELOAD_TOKEN=8d64ed06945 /home/custom/CustomBuild/scripts/fetch_release_cronjob.sh
...
reload_remotes_on_app() {
    ...
    curl -X POST https://custom.ardupilot.org/refresh_remotes \
